...
[com/linuxmint/install]
flatpak-remotes=['flathub::https://dl.flathub.org/repo/::False']
installed-apps=['apt:linux-hwe-6.17-headers-6.17.0-14', 'apt:linux-hwe-6.17-tools-6.17.0-14', 'apt:vainfo', 'apt:vdpauinfo']

[com/linuxmint/updates]
default-repo-is-ok=true
install-last-run=1772750120
refresh-last-run=1772849155
...
[org/blueman/general]
window-properties=[529, 350, 50, 82]
...
enabled-applets=['panel1:left:0:menu@cinnamon.org:0', 'panel1:right:6:notifications@cinnamon.org:5', 'panel1:right:8:removable-drives@cinnamon.org:7', 'panel1:right:9:keyboard@cinnamon.org:8', 'panel1:right:11:network@cinnamon.org:10', 'panel1:right:12:sound@cinnamon.org:11', 'panel1:right:13:power@cinnamon.org:12', 'panel1:right:14:calendar@cinnamon.org:13', 'panel1:right:15:cornerbar@cinnamon.org:14', 'panel1:right:3:systray@cinnamon.org:15', 'panel1:right:2:xapp-status@cinnamon.org:16', 'panel1:left:1:grouped-window-list@cinnamon.org:18']
enabled-desklets=@as []
...
picture-uri='file:///usr/share/backgrounds/linuxmint/sele_linuxmint_center.jpg'
...
binding=['<Alt>grave']
command='gnome-screenshot -ca'
name='custom_area_screenshot'

[org/cinnamon/desktop/keybindings/media-keys]
area-screenshot=@as []
logout=['<Shift><Super>m']
restart-cinnamon=@as []
screensaver=@as []
...
switch-to-workspace-up=['<Super>equal']
...
night-light-last-coordinates=(31.780556000000001, 35.223889)
night-light-schedule-mode='always'
...
window-position=(412, 62)
window-size=(1096, 822)

[org/nemo/window-state]
geometry='1409x710+256+101'
maximized=false
...
active-plugins=['docinfo', 'modelines', 'time', 'filebrowser', 'joinlines', 'textsize', 'spell', 'open-uri-context-menu', 'sort', 'bracketcompletion']

[org/x/editor/plugins/filebrowser/on-load]
root='file:///'
tree-view=true
virtual-root='file:///media/user/Local%20Disk/pentesting'
...
autostart=false
connect-id='COMPUTER-126F48C6C03444C136B6'
no-overwrite=true
